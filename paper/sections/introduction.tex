...
We therefore invert combinatorial testing (Figure~\ref{fig:concept}). Instead of
covering input combinations and observing whatever outputs result, \rnwise{}
Output-Oriented Testing:
\begin{enumerate}
