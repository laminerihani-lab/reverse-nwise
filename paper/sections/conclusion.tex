...
available with pinned dependencies and a container image for deterministic
reproduction,
\ifanon
at an anonymised artifact repository provided to reviewers.
\else
at \url{https://github.com/laminerihani-lab/reverse-nwise}.
\fi
